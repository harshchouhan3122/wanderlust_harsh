const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              <p>Hello <b>{name}</b>, </p>
              <p>Thank you for signing up! Please verify your email address by using the below OTP <i>(valid for 5 minutes)</i>:</p>
              <span class="verification-code">{OTP}</span>
              <p>If you did not create an account, no further action is required. If you have any questions, feel free to contact our support team.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Wanderlust Private Limited. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
